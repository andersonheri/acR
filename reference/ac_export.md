...
#> ✔ Exportado para /tmp/RtmpP3ZjbX/resultados.csv (csv).
...
#> ✔ Exportado para /tmp/RtmpP3ZjbX/resultados.tex (latex).

# RDS (replicabilidade)
ac_export(resultados, out_rds)
#> ✔ Exportado para /tmp/RtmpP3ZjbX/resultados.rds (rds).
...
#> ✔ Exportado para /tmp/RtmpP3ZjbX/resultados.xlsx (xlsx).
...
#> ✔ Exportado para /tmp/RtmpP3ZjbX/confiabilidade.csv (csv).
```
