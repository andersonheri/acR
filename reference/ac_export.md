...
#> ✔ Exportado para /tmp/RtmpWckz6C/resultados.csv (csv).
...
#> ✔ Exportado para /tmp/RtmpWckz6C/resultados.tex (latex).

# RDS (replicabilidade)
ac_export(resultados, out_rds)
#> ✔ Exportado para /tmp/RtmpWckz6C/resultados.rds (rds).
...
#> ✔ Exportado para /tmp/RtmpWckz6C/resultados.xlsx (xlsx).
...
#> ✔ Exportado para /tmp/RtmpWckz6C/confiabilidade.csv (csv).
```
