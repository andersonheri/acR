...
#> ✔ Exportado para /tmp/RtmpIkbFfn/resultados.csv (csv).
...
#> ✔ Exportado para /tmp/RtmpIkbFfn/resultados.tex (latex).

# RDS (replicabilidade)
ac_export(resultados, out_rds)
#> ✔ Exportado para /tmp/RtmpIkbFfn/resultados.rds (rds).
...
#> ✔ Exportado para /tmp/RtmpIkbFfn/resultados.xlsx (xlsx).
...
#> ✔ Exportado para /tmp/RtmpIkbFfn/confiabilidade.csv (csv).
```
