...
#> ✔ Exportado para /tmp/RtmpvqdQdJ/resultados.csv (csv).
...
#> ✔ Exportado para /tmp/RtmpvqdQdJ/resultados.tex (latex).

# RDS (replicabilidade)
ac_export(resultados, out_rds)
#> ✔ Exportado para /tmp/RtmpvqdQdJ/resultados.rds (rds).
...
#> ✔ Exportado para /tmp/RtmpvqdQdJ/resultados.xlsx (xlsx).
...
#> ✔ Exportado para /tmp/RtmpvqdQdJ/confiabilidade.csv (csv).
```
