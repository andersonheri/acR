...
#> ✔ Exportado para /tmp/Rtmp3qN8jV/resultados.csv (csv).
...
#> ✔ Exportado para /tmp/Rtmp3qN8jV/resultados.tex (latex).

# RDS (replicabilidade)
ac_export(resultados, out_rds)
#> ✔ Exportado para /tmp/Rtmp3qN8jV/resultados.rds (rds).
...
#> ✔ Exportado para /tmp/Rtmp3qN8jV/resultados.xlsx (xlsx).
...
#> ✔ Exportado para /tmp/Rtmp3qN8jV/confiabilidade.csv (csv).
```
