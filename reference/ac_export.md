...
#> ✔ Exportado para /tmp/RtmpfTv5LA/resultados.csv (csv).
...
#> ✔ Exportado para /tmp/RtmpfTv5LA/resultados.tex (latex).

# RDS (replicabilidade)
ac_export(resultados, out_rds)
#> ✔ Exportado para /tmp/RtmpfTv5LA/resultados.rds (rds).
...
#> ✔ Exportado para /tmp/RtmpfTv5LA/resultados.xlsx (xlsx).
...
#> ✔ Exportado para /tmp/RtmpfTv5LA/confiabilidade.csv (csv).
```
