...
#> ✔ Exportado para /tmp/RtmpMjJzyl/resultados.csv (csv).
...
#> ✔ Exportado para /tmp/RtmpMjJzyl/resultados.tex (latex).

# RDS (replicabilidade)
ac_export(resultados, out_rds)
#> ✔ Exportado para /tmp/RtmpMjJzyl/resultados.rds (rds).
...
#> ✔ Exportado para /tmp/RtmpMjJzyl/resultados.xlsx (xlsx).
...
#> ✔ Exportado para /tmp/RtmpMjJzyl/confiabilidade.csv (csv).
```
