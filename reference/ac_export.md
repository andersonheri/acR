...
#> ✔ Exportado para /tmp/RtmpdnyHxr/resultados.csv (csv).
...
#> ✔ Exportado para /tmp/RtmpdnyHxr/resultados.tex (latex).

# RDS (replicabilidade)
ac_export(resultados, out_rds)
#> ✔ Exportado para /tmp/RtmpdnyHxr/resultados.rds (rds).
...
#> ✔ Exportado para /tmp/RtmpdnyHxr/resultados.xlsx (xlsx).
...
#> ✔ Exportado para /tmp/RtmpdnyHxr/confiabilidade.csv (csv).
```
