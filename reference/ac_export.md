...
#> ✔ Exportado para /tmp/RtmpXbx59n/resultados.csv (csv).
...
#> ✔ Exportado para /tmp/RtmpXbx59n/resultados.tex (latex).

# RDS (replicabilidade)
ac_export(resultados, out_rds)
#> ✔ Exportado para /tmp/RtmpXbx59n/resultados.rds (rds).
...
#> ✔ Exportado para /tmp/RtmpXbx59n/resultados.xlsx (xlsx).
...
#> ✔ Exportado para /tmp/RtmpXbx59n/confiabilidade.csv (csv).
```
