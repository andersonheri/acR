...
#> ✔ Exportado para /tmp/RtmpWG91QW/resultados.csv (csv).
...
#> ✔ Exportado para /tmp/RtmpWG91QW/resultados.tex (latex).

# RDS (replicabilidade)
ac_export(resultados, out_rds)
#> ✔ Exportado para /tmp/RtmpWG91QW/resultados.rds (rds).
...
#> ✔ Exportado para /tmp/RtmpWG91QW/resultados.xlsx (xlsx).
...
#> ✔ Exportado para /tmp/RtmpWG91QW/confiabilidade.csv (csv).
```
