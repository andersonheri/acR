...
> **Nota sobre o modo `think`:** O `qwen3.6` suporta raciocinio em
> cadeia (`think = TRUE`), util para categorias ambiguas ou codebooks
> complexos. Para codificacoes diretas com categorias bem definidas, use
> `think = FALSE` para reduzir custo e latencia.
