...
Descreva resumidamente as mudanças propostas neste PR.
...
Bug fix (mudança que corrige um problema sem quebrar API existente)

Nova funcionalidade (mudança que adiciona funcionalidade sem quebrar API
existente)
...
Meu código segue o estilo do projeto (tidyverse style guide)
...
Adicione qualquer informação adicional útil para revisão (decisões de
design, trade-offs considerados, etc.).
