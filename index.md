...
de sentimento (OpLexicon), co-ocorrência e modelagem de tópicos via LDA.
...
calcula confiabilidade entre codificação LLM e humana com intervalos de
confiança via bootstrap (Krippendorff alpha, Gwet AC1, F1-macro e
...
salvam e carregam codebooks em YAML.
...
identifica vocabulário distintivo entre grupos.
[`ac_cooccurrence()`](https://andersonheri.github.io/acR/reference/ac_cooccurrence.md)
monta rede de co-ocorrência com PMI e coeficiente Dice.
[`ac_sentiment()`](https://andersonheri.github.io/acR/reference/ac_sentiment.md)
calcula sentimento por documento usando OpLexicon.
...
Testes de integração com APIs externas (OpenAlex, LLMs) usam
`skip_on_cran()` e verificação prévia de disponibilidade para evitar
falhas em CI.
...
- [Codificação qualitativa com
  ...
  — pipeline completo com dados reais da Câmara
